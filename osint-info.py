...
information = "["+Fore.YELLOW+"I"+Fore.RESET+"]"
...
try:
	...
	while True:		choix = input("\n OSINT-INFO("+Fore.BLUE + "~" + Fore.RESET + ")$ ")
		...
		if choix.lower() == 'h':
			...
			while True:
				...
				choix = input("\n OSINT-INFO("+Fore.BLUE + "Profiler" + Fore.RESET + ")$ ")
			...
			while True:
				...
				lookup = input("\n OSINT-INFO("+Fore.YELLOW+"Lookup"+Fore.BLUE + "" + Fore.RESET + ")$ ")
			...
			while True:
				...
				se = input("\n OSINT-INFO("+Fore.BLUE+"OtherTool"+Fore.BLUE + "" + Fore.RESET + ")$ ")
			...
			while True:
				...
				newCode = input("\n OSINT-INFO("+Fore.YELLOW+"Country"+Fore.BLUE + "" + Fore.RESET + ")$ ")
